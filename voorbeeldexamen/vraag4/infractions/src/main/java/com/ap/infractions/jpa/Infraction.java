package com.ap.infractions.jpa;
...
public class Infraction implements Comparable<Infraction> {
    ...
    public int compareTo(Infraction ov) {
        return Integer.compare(Integer.parseInt(this.infractions_speed),
                Integer.parseInt(ov.infractions_speed));
        // try {
        // if (Integer.parseInt(this.infractions_speed) ==
        // Integer.parseInt(ov.infractions_speed))
        // return 0;
        // else if (Integer.parseInt(this.infractions_speed) >
        // Integer.parseInt(ov.infractions_speed))
        // return 1;
        // else
        // return -1;
